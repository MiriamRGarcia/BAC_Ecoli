...
addpath(genpath(fullfile(inputs.pathd.AMIGO_path,'add_InvDynamicOpt')));
...
switch computer
    ...
    case 'MACI64'
        ...
        setenv('LD_LIBRARY_PATH', ['/usr/local/lib:' '/usr/lib:' pwd '/Kernel/libAMIGO/lib_linux64:' getenv('LD_LIBRARY_PATH')]);
        setenv('DYLD_LIBRARY_PATH', ['/usr/local/lib:' '/usr/lib:' pwd '/Kernel/libAMIGO/lib_linux64']);
        %!export DYLD_LIBRARY_PATH
        
        
    case 'GLNXA64'
        setenv('LD_LIBRARY_PATH', ['/usr/local/lib:' getenv('LD_LIBRARY_PATH')]);
        setenv('LD_LIBRARY_PATH', [pwd '/Kernel/libAMIGO/lib_linux64:' getenv('LD_LIBRARY_PATH')]);
