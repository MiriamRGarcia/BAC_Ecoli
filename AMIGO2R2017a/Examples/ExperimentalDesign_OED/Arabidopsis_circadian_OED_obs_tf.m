...
%
 ...
 inputs.exps.max_obs{3}=3;                             % Maximum number of observables
 inputs.exps.index_obs_guess{3}=[1 1 1 0 0 0 0];       % Initial guess: 1: measured state;  0: unmeasured state
 ...
 inputs.exps.tf_type{3}='od';                          % [] Type of experiment duration: 'fixed'(default) | 'od' (to be designed) 
 inputs.exps.tf_min{3}=60;                             % Experiment minimum duration
 inputs.exps.tf_max{3}=120;                            % Experiment maximum duration
...
inputs.nlpsol.eSS.local.solver = 'ipopt';
