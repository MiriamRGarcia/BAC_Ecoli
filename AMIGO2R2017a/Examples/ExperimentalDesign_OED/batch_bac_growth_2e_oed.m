% $Header: svn://.../trunk/AMIGO2R2016/Examples/batch_bac_growth/batch_bac_growth_2e_oed.m 2410 2015-12-07 13:58:57Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%==================================
 ...
 inputs.exps.exp_y0{2}=[1.123e+000  5.000e+000 ];       % Initial conditions for each experiment       
 inputs.exps.t_f{2}=15;                               % Experiments duration
 inputs.exps.n_s{2}=11;                               % Number of sampling times
 inputs.exps.t_s{2}=linspace(0,inputs.exps.t_f{2},inputs.exps.n_s{2});  % [] Sampling times, by default equidistant
...
% 		Standard deviation: 10.000000%
 ...
 inputs.PEsol.global_theta_guess=[3.9990e-001 	4.9637e+000 	5.0819e-002 	5.0531e-001]; % best obtained with llk
 
 conf_intervals=[1.7133e-002   2.9647e-001   2.9936e-003  1.4074e-002];
 inputs.PEsol.global_theta_min=inputs.PEsol.global_theta_guess; %[0.3781    4.5824    0.0471    0.4878]; % theguess-1.25*conf
 inputs.PEsol.global_theta_max=inputs.PEsol.global_theta_guess; %[0.4209    5.3236    0.0546    0.5230];
