% $Header: svn://.../trunk/AMIGO2R2016/Examples/batch_bac_growth/batch_bac_growth_OED.m 2398 2015-12-04 07:06:07Z evabalsa $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%==================================
 ...
 inputs.exps.t_con{1}=[];                      % Initial time-Times of changes for the stimuli- Final stimulation time
                  % Initial time-Times of changes for the stimuli- Final stimulation time
...
% 		Error data 1: 
 ...
 inputs.exps.tf_type{2}='od';               % [] Type of experiment duration: 'fixed'(default) | 'od' (to be designed) 
 inputs.exps.tf_min{2}=8;
 inputs.exps.tf_max{2}=20;
