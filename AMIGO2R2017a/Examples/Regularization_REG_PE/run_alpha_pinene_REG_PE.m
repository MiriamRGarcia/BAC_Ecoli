...
% RUN Alpha-pinene model parameter estimation example with regularization
clear all;

alpha_pinene_REG_PE     % Calls the script with the inputs: 
                        % Model
...
[reg_summary results inputs]= AMIGO_REG_PE(inputs)    % Calls the task for Parameter Estimation
                                                      % with regularization
