%% AMIGO_FIM -- calculate Fisher Information, Parameters Covariance Matrix and Correlations
...
AMIGO_htmldoc_inputs(inputs,fullfile(pwd,'html','fimex1.html'));
