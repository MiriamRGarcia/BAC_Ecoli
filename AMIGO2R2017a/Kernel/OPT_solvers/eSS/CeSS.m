% $Header: svn://.../trunk/AMIGO2R2016/Kernel/OPT_solvers/eSS/CeSS.m 770 2013-08-06 09:41:45Z attila $
function Results = CeSS(par_struct,n_iter,is_parallel,varargin)
...
for iteration = 1:n_iter
    ...
    parfor thread=1:n_threads
        initCobraToolbox
        res = ess_kernel(par_struct(thread).problem, par_struct(thread).opts,varargin{:});
