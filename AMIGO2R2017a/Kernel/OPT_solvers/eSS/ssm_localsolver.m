% $Header: svn://.../trunk/AMIGO2R2016/Kernel/OPT_solvers/eSS/ssm_localsolver.m 2031 2015-08-24 11:49:26Z attila $
...
switch local_solver
    ...
    case 'dhc'
        ...
        [fval,x,numeval]=dhc(fobj,X0,initsize,thres,5000,x_L,x_U,weight,c_L,c_U,local_iterprint,tolc,varargin{:});
        exitflag=1;
