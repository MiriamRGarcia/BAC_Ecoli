...
icl -c /O2 src\src_amigo\*.c /I"include/include_amigo" /I"include/include_cvodes"  /Qmkl   
icl -c /O2 src\src_cvodes\*.c /I"include/include_cvodes"  /Qmkl
icl -c /O2 src\src_mxInterface\AMIGO_mxInterface.c /I"include/include_f2c" /I"include/include_cvodes" /I"include/include_amigo" /I"include/include_mxInterface" /I"C:\MATLAB_R2015b_64\extern\include" /Qmkl 

%lib /out:"lib_win64\libAMIGO.lib"  *.obj
