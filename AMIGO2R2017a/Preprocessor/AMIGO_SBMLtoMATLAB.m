% $Header: svn://.../trunk/AMIGO2R2016/Preprocessor/AMIGO_SBMLtoMATLAB.m 770 2013-08-06 09:41:45Z attila $
...
%      United Kingdom
%
%  Generates a function of ODEs to be solved by ODE15s
...
if flag==0
fprintf(fileID,  'function dydt = fcnm(%s,y,flag,par,v,pend,tlast)\n',  timeVariable);
else
 fprintf(fileID,  'function dydt = sensm(%s,y,flag,par,v,pend,tlast)\n',  timeVariable);
end
