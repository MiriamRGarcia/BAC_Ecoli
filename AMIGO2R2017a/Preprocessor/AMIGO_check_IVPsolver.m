...
switch inputs.model.input_model_type
    case    'charmodelC'
        if ~isfield(inputs.ivpsol,'ivpsolver') || isempty(inputs.ivpsol.ivpsolver) || ~strcmp(inputs.ivpsol.ivpsolver,'cvodes')
            ...
            warning('AMIGO_check_IVPsolver: Changing ivp solver to the only option compatible with charmodelC, cvodes');
        end
...
if ~isfield(inputs.ivpsol,'ivpsolver') || isempty(inputs.ivpsol.ivpsolver)
    ...
    switch inputs.model.input_model_type
        ...
        case {'charmodelC'}
            ...
            fprintf(1,'\t\t To generate dlls (by default) radau5 is used.\n');
            fprintf(1,'\t\t If you want to use a different solver, please update your input file. \n');
            inputs.ivpsol.ivpsolver='radau5';
            
        case {'sbmlmodel','matlabmodel','charmodelM'}
...
switch inputs.model.input_model_type
    case {'charmodelC','amigoCgenerator'}
