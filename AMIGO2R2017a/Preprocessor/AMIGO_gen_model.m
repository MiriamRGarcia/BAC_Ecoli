    ...
    case 'standard'
        ...
        switch inputs.model.input_model_type
            ...
            case 'sbmlmodel'
                ...
                model=TranslateSBML(strcat(inputs.model.sbmlmodel_file,'.xml'));
                AMIGO_SBMLtoMATLAB(model,'fcnm.m',0);
                AMIGO_SBMLtoMATLAB(model,'sensm.m',1);
