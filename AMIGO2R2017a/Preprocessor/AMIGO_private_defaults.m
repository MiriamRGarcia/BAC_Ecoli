...
% Code development:     Eva Balsa-Canto, Attila G�bor, David Henriques        %
...
inputs_def.model.compile_model=1;
%----------------------------------------------------------------------------------------------------------------
%
% MODEL RELATED DATA
%
...
inputs_def.exps.n_exp=300; %180                  % number of maximum default experiments
