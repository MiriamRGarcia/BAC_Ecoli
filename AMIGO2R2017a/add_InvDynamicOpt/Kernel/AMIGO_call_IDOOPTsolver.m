...
% AMIGO_call_ODOPTsolver:  Calls the optimization solver selected by user for OD 
        ...
        case 'de'
            ...
            AMIGO_report_guess_bounds(vguess,vmin,vmax,inputs.pathd.report);  
                ...
                cost_function=inputs.pathd.IDO_function;
        ...
        case 'sres'
         ...
         case 'ssm'
            ...
            problem.f=inputs.pathd.IDO_function;    
            eval(sprintf('%s',inputs.pathd.IDO_constraints))
      ...
      case {'ess','eSS'}           
         ...
         case 'monlot'
            ...
            inputs.nlpsol.nlp_opts.nobjs=inputs.IDOsol.N_DOcost;
            inputs.nlpsol.nlp_opts.fun=inputs.pathd.IDO_function; 
...
%             end
            ...
            inputs.nlpsol.nsga2.numObj=inputs.IDOsol.N_DOcost;
            inputs.nlpsol.nsga2.numCons=results.nlpsol.ntotalconstraints;
            inputs.nlpsol.nsga2.objfun=inputs.pathd.IDO_function;     
            inputs.nlpsol.nsga2.nameObj=inputs.IDOsol.IDOcost;
