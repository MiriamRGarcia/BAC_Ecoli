...
function [inputs,privstruct]= AMIGO_check_IDO(input_file,inputs_def)
...
%
    ...
    inputs.IDOsol=inputs_def.IDOsol;
...
%
    ...
    inputs.exps.u{iexp}=inputs.IDOsol.u_guess{iexp};
    inputs.exps.u_max{iexp}=inputs.IDOsol.u_max{iexp};
    inputs.exps.u_min{iexp}=inputs.IDOsol.u_min{iexp};
    inputs.exps.t_con{iexp}= inputs.IDOsol.t_con{iexp};     
    inputs.exps.u_interp{iexp}=inputs.IDOsol.u_interp;
    inputs.exps.n_pulses{iexp}=inputs.IDOsol.n_pulses{iexp};
    inputs.exps.n_steps{iexp}=inputs.IDOsol.n_steps{iexp};
    inputs.exps.n_linear{iexp}=inputs.IDOsol.n_linear{iexp};
