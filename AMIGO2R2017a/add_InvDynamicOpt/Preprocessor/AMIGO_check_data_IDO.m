...
switch inputs.exps.data_type
    ...
    case {'pseudo','pseudo_pos'}
        ...
        [inputs,results]= AMIGO_check_sampling(inputs,results);
...
%                     end
    ...
    case 'real'
        ...
        if strcmp(inputs.IDOsol.IDOcost_type,'llk')
            ...
            if (strcmp(inputs.IDOsol.llk_type,'homo') || strcmp(inputs.IDOsol.llk_type,'homo_var')) 
...
if ~isfield(inputs.IDOsol,'PEcost_type') || isempty(inputs.IDOsol.PEcost_type)
    inputs.IDOsol.PEcost_type='lsq';
    fprintf(1,'\n\n------> WARNING message\n\n');
